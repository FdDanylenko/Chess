...
export class Board{
  ...
  public addTestPieces(){
    ...
    new Queen(Colors.WHITE, this.getCell(4, 3));
    new Pawn(Colors.WHITE, this.getCell(0, 5));
    //============================================
    new King(Colors.BLACK, this.getCell(5, 0));
    new Knight(Colors.BLACK, this.getCell(4, 0));
    new Knight(Colors.BLACK, this.getCell(6, 0));
    //new Pawn(Colors.BLACK, this.getCell(6, 0));
  }

  public addTes2tPieces(){
    new King(Colors.WHITE, this.getCell(4, 7));
    new Queen(Colors.WHITE, this.getCell(1, 5));
    new Bishop(Colors.WHITE, this.getCell(2, 7));
    ...
    new Bishop(Colors.WHITE, this.getCell(6, 4));
    //============================================
    new King(Colors.BLACK, this.getCell(4, 0));
    new Queen(Colors.BLACK, this.getCell(3, 0));
    new Bishop(Colors.BLACK, this.getCell(2, 0));
